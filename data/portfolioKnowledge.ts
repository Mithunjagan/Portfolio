export const portfolioKnowledge = {
    ...
    schoolHistory: [
      {
        ...
        institution: "Apex Pon Vidhyashram"
      },
      {
      ...
      },
      {
        ...
        purpose: "JEE and NEET preparation"
      }
    ],
    relevantCourses: [
  ...
  projects: [
    ...
    {
      id: "smart-classroom-iot",
      title: "Smart Classroom IoT System",
      description: "A wearable edge-biometric and motion gateway monitoring classroom student health and activity metrics.",
      technologies: ["Raspberry Pi", "MAX30100", "MPU6050", "MLX90614", "Firebase", "React"],
      keyFeatures: [
        "Wearable edge node reading heart rate, temperature, and motion parameters",
        "Wi-Fi gateway linking Raspberry Pi controller to Firebase database",
        "Live React web dashboard rendering individual and aggregate analytics"
      ]
    },
    {
      id: "shaurya-racing",
